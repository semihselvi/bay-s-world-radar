...
def test_nc_cases():
    cases = [
        ...
        (
            "reviewed_four_seasons_supply_without_price",
            "Аренда Four Seasons Апартаменты 2+1 в комплексе Four Seasons Уютные апартаменты для комфортного отдыха и проживания Джакузи на крыше. Отличный вариант для отдыха на море или длительного проживания Посуточная аренда Долгосрочная аренда",
            "OWNER",
            [],
        ),
        (
            "reviewed_alsancak_price_before_rental_terms",
            "Алсанджак, 3+1 вилла с бассейном. Техника Bosch. 1800£, условия 1 аренда 2 депозита 1 комиссия + бассейн, сад и коммунальные. Долгосрочная аренда",
            "OWNER",
            [],
        ),
        (
            "reviewed_property_management_service",
            "ВАША КВАРТИРА НА LONG BEACH — ПУСТЬ РАБОТАЕТ НА ВАС! ВОЗЬМУ ВАШУ КВАРТИРУ В УПРАВЛЕНИЕ! Если у вас есть квартира на Long Beach, но вы живёте в другой стране или просто не хотите заниматься арендой самостоятельно — я возьму все заботы на себя.",
            "UNKNOWN",
            [],
        ),
        (
        ...
        (
            "reviewed_numeric_date_range_is_short_term",
            "Сниму 1+1 или 2+1 с 15.09 по 22.09 в Афродите (Гюзельверен)",
            "TENANT",
            ["SHORT_TERM_TENANT"],
        ),
        (
            "reviewed_grand_sapphire_short_term_demand",
            "Ищу для аренды Гранд Сапфир, студию. Можно месяц или посуточно во второй половине сентября",
            "TENANT",
            ["SHORT_TERM_TENANT"],
        ),
        (
            "reviewed_budgeted_real_tenant_not_supply",
            "Сниму 3+1 на год, бюджет 1000£",
            "TENANT",
            ["LONG_TERM_TENANT"],
        ),
        (
            "reviewed_three_month_real_tenant",
            "Хочу снять на 3-4 месяца квартиру, с 20 сентября, раздельные 2 спальных места, желательно в комплексе с удобствами. Ищу до 500 евро",
            "TENANT",
            [],
        ),
        (

...
# World Radar freshness policy: for the production fresh scan, only Exa's
# explicit publishedDate is accepted as authoritative. We do not infer a
# publication date from arbitrary historical dates inside page text.
...
# Force Exa itself to return only freshly published pages.
...
# Six low-cost, market-focused fresh discovery buckets.
main.SOURCE_BUCKETS = [
    {
